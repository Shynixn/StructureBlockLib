package com.github.shynixn.structureblocklib.business.bukkit.nms.v1_12_R1;
...
public class CraftStructureBlock112R1Test {
    ...
    public void structureBlockBehaviourTest() {
        ...
        final StructureBlock structureBlock = new CraftStructureBlock(structure);
    ...
    public void structureBlockConstructionBehaviourTest() {
        ...
        final StructureBlockConstruction structureBlock = new CraftStructureBlock(structure);
    ...
    public void structureBlockSaveLoadCornerDataBehaviourTest() {
        ...
        StructureBlockSave structureBlockSave = new CraftStructureBlock(structure);
