...
import com.github.shynixn.structureblocklib.bukkit.v1_13_R2.CraftStructureBlock;
import com.github.shynixn.structureblocklib.bukkit.v1_13_R2.StructureSerializationServiceImpl;
import com.github.shynixn.structureblocklib.bukkit.v1_13_R2.TypeConversionServiceImpl;
...
public class CraftStructureBlockIT {
    ...
    private CraftStructureBlock createWithDependencies(ProxyService proxyService, TileEntityStructure tileEntityStructure) {
        ...
        WorldServer world = Mockito.mock(WorldServer.class);
        Mockito.when(craftWorld.getHandle()).thenReturn(world);
